...
function expstickybar(usersetting){
	var setting=jQuery.extend({position:'bottom', peekamount:40, revealtype:'mouseover', speed:200}, usersetting)
	var thisbar=this
...
expstickybar.prototype={
	...
	showhide:function(keyword, anim){
       ...
       $('.panel-body').css( "padding-bottom", this.height );
